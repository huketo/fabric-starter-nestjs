...
function createOrderer() {
  ...
  infoln "Registering raft0"
  set -x
  fabric-ca-client register --caname ca-orderer --id.name raft0 --id.secret raft0pw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null

  infoln "Registering raft1"
  set -x
  fabric-ca-client register --caname ca-orderer --id.name raft1 --id.secret raft1pw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
  
  infoln "Registering raft2"
  set -x
  fabric-ca-client register --caname ca-orderer --id.name raft2 --id.secret raft2pw --id.type orderer --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the raft0 msp"
  set -x
  fabric-ca-client enroll -u https://raft0:raft0pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/msp" --csr.hosts raft0.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null

  cp "${PWD}/organizations/ordererOrganizations/example.com/msp/config.yaml" "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/msp/config.yaml"

  infoln "Generating the raft1 msp"
  set -x
  fabric-ca-client enroll -u https://raft1:raft1pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft1.example.com/msp" --csr.hosts raft1.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://raft2:raft2pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft2.example.com/msp" --csr.hosts raft2.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the raft0-tls certificates"
  set -x
  fabric-ca-client enroll -u https://raft0:raft0pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls" --enrollment.profile tls --csr.hosts raft0.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null

  # Copy the tls CA cert, server cert, server keystore to well known file names in the orderer's tls directory that are referenced by raft0 startup config
  cp "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/tlscacerts/"* "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/ca.crt"
  cp "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/signcerts/"* "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/server.crt"
  cp "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/keystore/"* "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/server.key"

  # Copy orderer org's CA cert to orderer's /msp/tlscacerts directory (for use in the raft0 MSP definition)
  mkdir -p "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/msp/tlscacerts"
  cp "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/tls/tlscacerts/"* "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft0.example.com/msp/tlscacerts/tlsca.example.com-cert.pem"

  infoln "Generating the raft1-tls certificates"
  set -x
  fabric-ca-client enroll -u https://raft1:raft1pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft1.example.com/tls" --enrollment.profile tls --csr.hosts raft1.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null

  # Copy the tls CA cert, server cert, server keystore to well known file names in the orderer's tls directory that are referenced by raft1 startup config
  ...
  # Copy orderer org's CA cert to orderer's /msp/tlscacerts directory (for use in the raft1 MSP definition)
  ...
  set -x
  fabric-ca-client enroll -u https://raft2:raft2pw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/example.com/orderers/raft2.example.com/tls" --enrollment.profile tls --csr.hosts raft2.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null

  # Copy the tls CA cert, server cert, server keystore to well known file names in the orderer's tls directory that are referenced by raft2 startup config
  ...
  # Copy orderer org's CA cert to orderer's /msp/tlscacerts directory (for use in the raft2 MSP definition)
